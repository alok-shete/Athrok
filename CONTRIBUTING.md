# Contributing to Athrok

Thank you for considering contributing to Athrok! We welcome contributions of all kinds, including bug reports, feature requests, and code improvements.
...
2. **Clone your fork** to your local machine:
   ```sh
   git clone https://github.com/alok-shete/athrok.git
   ```
...
Thank you for contributing to Athrok! Your support and involvement help make this project better for everyone.
